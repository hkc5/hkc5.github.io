...
export default function SEO({ 
  ...
  url = "https://hakancanozturk.com",
  image = "https://hakancanozturk.com/profile.webp"
}: SEOProps) {
  useEffect(() => {
    ...
    setMetaTag('keywords', 'machine learning, software engineer, Amazon, RAG, computational fluid dynamics, AI, data science');
    ...
    const structuredData = {
      ...
      "url": url,
      "sameAs": [
        "https://linkedin.com/in/hakancan",
        "https://github.com/hkc5"
      ],
      "knowsAbout": [
        "Machine Learning",
