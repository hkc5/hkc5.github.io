...
const PRESETS: Preset[] = [
  ...
  {
    name: 'Neon',
    desc: 'Muted pastel, soft ambient flow',
    config: {
  ...
  {
    name: 'Vivid',
    desc: 'Bold bright colors, moderate persistence',
    config: {
